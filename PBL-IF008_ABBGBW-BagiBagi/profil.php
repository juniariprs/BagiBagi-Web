            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    ...
                    <div class="form-group">
                        <div class="text-left">
                            <img src="img/pengguna/<?= $row['foto_profil']; ?>" width="192px" height="192px" class="avatar img-circle img-thumbnail" alt=" ">
                        </div>
                    </div>
                ...
                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                <div class="col-lg-8">
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <label for="profile_name">
                                                <h5><?php echo $row['nama_profil'] ?></h5>
                                            </label>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-lg-8">
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <label for="user_name">
                                                <h5><?php echo $row['id_pengguna'] ?></h5>
                                            </label>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div class="col-lg-12">
                        <button class="site-btn">
                            <a href="edit_profil.php">
                                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                <i class="fa fa-edit text-white rounded fa-1x"></i>
                                Edit &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                            </a>
                        </button>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <button class="site-btn">
                            <a href="ubah_kata-sandi.php">
                                <i class="fa fa-key text-white rounded fa-1x"></i>
                                Ubah kata sandi
                            </a>
                        </button>
                    </div>
