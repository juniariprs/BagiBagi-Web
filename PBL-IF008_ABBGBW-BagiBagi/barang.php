            ...
            <div class="row">
                ...
                <div class="product-list">
                    <div class="row">
                        ...
                        include 'kueri.php';
                        if ($_GET['search'] != '') {
                            $where = "WHERE barang.nama_barang LIKE '%" . $_GET['search'] . "%'";
                        }
                        $sql = "SELECT * FROM barang LEFT JOIN kategori ON barang.id_kategori = kategori.id_kategori $where ORDER BY id_barang DESC";
                        $data = query($sql);
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div class="product-item">
                                        ...
                                        <div class="pi-text">
                                            ...
                                            <h5><a href="detail_barang.php?id_barang=<?php echo $row['id_barang']; ?>"><?= $row['nama_barang'] ?></a></h5>
