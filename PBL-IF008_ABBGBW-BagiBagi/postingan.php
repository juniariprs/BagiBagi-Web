...
<body>
    ...
    <div class="col-md-10 p-5 pt-2">
        ...
        <table class="table table-stripped table-bordered">
            ...
            $barang = mysqli_query(
                $koneksi,
                "SELECT * FROM barang LEFT JOIN kategori ON barang.id_kategori = kategori.id_kategori WHERE barang.id_pengguna = '$user'"
            );
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="edit_barang.php?id_barang=<?php echo $row['id_barang']; ?>">
                                <i class="fa fa-edit bg-warning p-2 text-white rounded">
                                </i>
                            </a> |
                            <a href="hapus_barang.php?id_barang=<?php echo $row['id_barang']; ?>" onclick="return confirm('Yakin ingin menghapus?')">
                                <i class="fa fa-trash-o bg-secondary p-2 text-white rounded">
                                </i>
                            </a>
                        </td>
                    </tr>
